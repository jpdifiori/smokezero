    ...
    return (
        <div className="relative flex items-center justify-center p-10">
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="w-36 h-36 md:w-48 md:h-48 rounded-full bg-orange-pulse text-core-black font-bold text-lg md:text-2xl shadow-[0_0_50px_rgba(255,87,34,0.3)] z-10 flex flex-col items-center justify-center border-4 border-orange-pulse/50 hover:border-white transition-colors"
            >
