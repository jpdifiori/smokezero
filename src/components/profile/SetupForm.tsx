                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    placeholder="Juan"
                                    className="mt-1 block w-full px-3 py-3 border border-zinc-800 placeholder-zinc-600 text-white bg-zinc-900/50 rounded-lg focus:outline-none focus:ring-orange-pulse focus:border-orange-pulse sm:text-sm"
                                />
                            </div>
                            <div>
